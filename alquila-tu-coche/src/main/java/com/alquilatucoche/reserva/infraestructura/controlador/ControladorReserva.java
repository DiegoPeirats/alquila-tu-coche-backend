...
public class ControladorReserva {
	...
	public ResponseEntity<ReservaDTO> crearReserva(PeticionCrearReserva peticion){
		return ResponseEntity.status(HttpStatus.CREATED).body(servicio.crearReserva(peticion));
	}
	
	
	@PutMapping("/modificarReserva")
	public ResponseEntity<ReservaDTO> modificarReserva(PeticionModificarReserva peticion){
	...
	public ResponseEntity<List<ReservaDTO>> obtenerReservas(Long usuarioId){
